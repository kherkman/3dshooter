...
function init() {
    // Inject custom CSS to ensure perfect title centering & responsive intro scaling on mobile
...
function loadLevel(levelName, isInitialLoad = false, isLanding = false) {
    ...
    // Dynamic city window identification and precomputed bounding box caching
    cityWindows.length = 0;
    if (levelName === 'city') {
