...
function init() {
    ...
    cityWindowBrokenTexture = textureLoader.load('windowbroken.jpg');
    ...
    // Load Prop Textures (Trash can & Street light & Car)
    trashTexture = textureLoader.load('trash.jpg');
    streetLightTexture = textureLoader.load('streetlight.jpg');
    carTexture = textureLoader.load('car.jpg');
    carDestroyedTexture = textureLoader.load('car-destroyed.jpg', undefined, undefined, () => {
        carDestroyedTexture = textureLoader.load('cardestroyed.jpg');
    });
    ...
    pistolBodyTexture = textureLoader.load('pistolbody.jpg', onWeaponTextureLoad);
    ...
    // Set wrapping for Prop Textures
    trashTexture.wrapS = THREE.RepeatWrapping;
    trashTexture.wrapT = THREE.RepeatWrapping;
    streetLightTexture.wrapS = THREE.RepeatWrapping;
    streetLightTexture.wrapT = THREE.RepeatWrapping;
    ...
    pistolBodyTexture.wrapS = THREE.RepeatWrapping;
    pistolBodyTexture.wrapT = THREE.RepeatWrapping;
    ...
    // Expose Prop Textures globally
    window.trashTexture = trashTexture;
    window.trashCanTexture = trashTexture;
    window.streetLightTexture = streetLightTexture;
    window.carTexture = carTexture;
    window.carDestroyedTexture = carDestroyedTexture;
