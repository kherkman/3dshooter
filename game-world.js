const GameWorld = {
        ...
        city: {
            ...
            create: (scene, buildingColliders) => {
                ...
                for (let i = 0; i < 200; i++) { 
                    ...
                    // Kerätään paikkoja katutason prop-esineille (suurennetut roska-astiat / katuvalot)
                    ...
                    const wS = 2.0; 
                    // Ikkunat vasta 2. kerroksesta alkaen (Y = 4.0)
                ...
                if (propPlacementCandidates.length > 0) {
                    ...
                    // 1. Luodaan suurennetut roska-astiat
                    ...
                    // 2. Luodaan katuvalot TARKALLA tolpan törmäyslaatikolla (Estää lagin ja heittelyn)
    ...
    props: {
        createTrashCanMesh: () => {
            ...
            // Suurennetaan roska-astiaa 50 % kookkaammaksi (Scale 1.5x)
