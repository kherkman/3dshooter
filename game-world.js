    ...
    levels: {
        ...
        toxic: {
            ...
            create: (scene, buildingColliders, vegetation, bunkers) => {
                ...
                // Optimized: Reduced instanced grass from 220,000 to 50,000, scaling up models slightly to compensate.
                // This makes level load 4.4x faster and dramatically reduces draw calls and rendering load on low-end systems.
        ...
        crystal: {
            ...
            create: (scene, buildingColliders) => {
                ...
                for (let r = 0; r < mazeGridSize; r++) {
                    // Fixed typo in loop conditional block
    ...
    spacecraft: {
        createModel: () => {
            ...
            const cockpitMaterial = new THREE.MeshStandardMaterial({ 
                ...
                transparent: true, 
                opacity: 0.4 
            }); // Ei sovelleta spacecraft.jpg-tekstuuria tähän osaan.
