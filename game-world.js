    ...
    levels: {
        city: {
            ...
            create: (scene, buildingColliders) => {
                ...
                const sR = 15.0; 
                const wallCandidates = []; // Lista katutason seinistä graffiti-sijoittelua varten
                ...
                for (let i = 0; i < 200; i++) { 
                    ...
                    // Kerätään katutason seinäpintoja graffiteja varten (korkeus Y = 2.2)
                    const groundY = 2.2;
                    const offset = 0.03; // Hieman irti seinäpinnasta Z-fightingin estämiseksi
                    wallCandidates.push(
                    ...
                    const wS = 2.0; 
                    // POISTETTU ALIMMAT KATUTASON IKKUNAT: Aloitetaan Y-korkeudelta wS * 2 (Y = 4.0)
                ...
                // --- LISÄTÄÄN GRAFFITIT SATUNNAISIIN KATUTASON SEINIIN ---
                if (wallCandidates.length >= 2) {
                    ...
                    // Valitaan kaksi eri satunnaista seinäpintaa
