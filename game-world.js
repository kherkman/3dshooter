    ...
    levels: {
        city: {
            ...
            create: (scene, buildingColliders) => {
                ...
                // City Windows and Buildings using wall.jpg and window.jpg with InstancedMesh optimization
                ...
                const windowTransforms = []; // Kerätään kaikkien ikkunoiden muunnokset InstancedMesh-luontia varten
                ...
                // Luodaan kaikki ehyet ikkunat yhtenä valtavan tehokkaana InstancedMeshinä
